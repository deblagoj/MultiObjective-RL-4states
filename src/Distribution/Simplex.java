 ...
 *  
 *  http://algs4.cs.princeton.edu/65reductions/Simplex.java
 *
...
public class Simplex {
    ...
    private double [] demands;  //this first is the allocation
    

    
    public double get_SimplexResults () { return result;}
...
for (int i=0;i<weights.length;i++)
	...
	if (distribution[i]<demands[i+1]) sum+=Math.pow((demands[i+1]-distribution[i]), 2)*weights[i];
